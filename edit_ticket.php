...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
		...
		<?php if(isset($_SESSION['username'])): ?>	
			...
			?>
					<form class="container block" style="margin-top: 10px;" action="edit_ticket_handler.php?name1='<?php echo $name1?>'&pnr1='<?php echo $pnr1?>'" method="post">
					<div style="border: 1px solid grey; padding: 8px 30px;	background:#F8F8FF; margin-top: 30px;">
					<div class="form-row" style="margin-bottom:10px">
						<i class="fa fa-address-card w3-xlarge"></i><div style="margin-left: 20px;"></div>
					</div>
			  <div class="form-row" >
			    <div class="col-md mb-3">
			      <label for="validationDefault01">Name</label>
			      <input type="text" class="form-control" id="validationDefault01" name="name2" value="<?php if (isset($_POST['pass_name'])) echo $_POST['pass_name']; ?>" required>
			    </div>
			    <div class="col-md mb-3">
			      <label for="validationDefault02">Age</label>
			      <input type="number" class="form-control" id="validationDefault02" name="age" value="<?php if (isset($_POST['age'])) echo $_POST['age']; ?>" required>
			    </div>
			    <div class="col-md mb-3">
