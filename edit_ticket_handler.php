    ...
    <nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
		...
		<?php if(isset($_SESSION['username'])): ?>	
			...
			<?php 
                ...
                $q="UPDATE pass_details2 SET `name`='$name2', gender='$gender', age='$age' WHERE B_id=$pnr1 AND `name`=$name1";
                $r=mysqli_query($db2,$q);
				if($r)
                    echo '<h1 style="margin-top: 30px; color:#e91e63;"><b>Successfully edited</b></h1>';
                else
