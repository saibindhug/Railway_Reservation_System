...
<body>
	...
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
			  ...
			  <?php if(isset($_SESSION['username'])): ?>	
				...
				<?php if(!isset($_SESSION['username'])): ?>
				    ...
				    <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item active">
				        <a class="nav-link" href="admin_home.php">Add Trains<span class="sr-only">(current)</span></a>
				      </li>
				      <li class="nav-item">
				        <a class="nav-link" href="train_stas.php">Train Schedule</a>
				      </li>
			...
			<form method="post" action="train_details.php">
				<aside id="profile">
					<h2>WELCOME</h2>
					<h4>ADMINISTRATOR</h4>
					...
					<!--<div class="hjk"><input type="date" name="date" id="datePicker" placeholder="yyyy-mm-dd" class="uh" value="2019-11-27"required><div>
						<select name="classes" class="uh hjk" value="<?php if (isset($class)) echo $class; ?>"-->
						 ...
						 <button class="btn info hjk" name="trains">Add Trains</button></form>

						 <!--<script>document.getElementById('datePicker').valueAsDate = new Date();</script>-->
                         <form method="post" action="view_admin_tickets.php">
                         <button class="btn info hjk" name="trains">View all tickets</button><br></form>

                         <form method="post" action="view_admin_trains.php">
                         <button class="btn info hjk" name="trains">View all trains</button><br></form>
