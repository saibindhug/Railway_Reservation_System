	...
	<nav class="navbar sticky-top navbar-expand-sm navbar-dark bg-dark">
			...
			<form method="post" action="confirm.php">
				<aside id="profile">
					...
					<input type="text" name="from" placeholder="From*"  required pattern="[a-zA-Z]+" placeholder="letters only" ><br><br>
					<input type="text" name="to" placeholder="To*" required pattern="[a-zA-Z]+" placeholder="letters only" ><br>
